      ...
      <header className="flex flex-wrap items-center justify-between gap-4 pb-2 border-b border-border/50">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage and track your scheduled, in-flight, and delivered social
            posts.
          </p>
        </div>
      </header>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {groups[key].map((p) => (
                    ...
                    >
                      ...
                      <p className="line-clamp-3 text-sm text-foreground/90 leading-relaxed font-sans">
                        {p.content}
                      </p>
